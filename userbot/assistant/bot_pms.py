    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"Hey! 👤{mention},\
                        ...
                        \n\nPowered by [𝐁𝐋𝐀𝐂𝐊 𝐒𝐓𝐎𝐑𝐌](https://t.me/BlackStormOP)"
        buttons = [
            (
                Button.url("Repo", "https://github.com/TeamBlackStorm/black-storm"),
                Button.url(
                    "Deploy",
                    "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FMr-confused%2Fcatpack&template=https%3A%2F%2Fgithub.com%2FTeamblackStorm%2Fblack-storm",
                ),
            )
        ]
    else:
