...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://replit.com/@TeamBlackStorm/BLACK-STORM-2
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TeamBlackStorm/legendxgaurav.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "blackstormbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/c74900d4586a3fe38ab62.jpg"
    )
